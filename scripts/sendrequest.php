<?
/* 
send an RFI  or a followup to an RFI
*/
...
require_once "EventInfo.class.php";
$ei = new EventInfo($event_id);
$followup = isset($formvars->followup) ? '1' : '0';
// return an array of fetp_id => token_id for auto_login
$tokens = $ei->insertFetpsReceivingEmail($fetp_ids, $followup);

$emailtype = $followup ? 'followup' : '';
$orig_emailtext = $formvars->additionalText ? $formvars->additionalText ."\n\n" : '';
$orig_emailtext .= $ei->buildEmailForEvent($event_info, $emailtype);
