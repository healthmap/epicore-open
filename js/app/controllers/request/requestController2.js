...
>>>>>>> 40e4e4f4695f3564a9198dbecdaa614b1bde162e
...
>>>>>>> 40e4e4f4695f3564a9198dbecdaa614b1bde162e
      ...
      if (
        $scope.filtertype === "country" &&
        !$scope.rfiData.members.countries
      ) {
        $scope.isStep1Invalid = true;
      }
    ...
    $scope.saveCondition = function (direction) {
      ...
      if (direction === "back") {
        ...
        var valid_other =
          !$scope.rfiData.health_condition.other ||
          $scope.rfiData.health_condition.other_description;
        var health_condition_human_valid =
        ...
        var valid_other_animal =
          !$scope.rfiData.health_condition.other_animal ||
          $scope.rfiData.health_condition.other_animal_description;
        var health_condition_animal_valid =
        ...
        var health_condition_ok =
          !(
            $scope.rfiData.population.type == "H" &&
            !health_condition_human_valid
          ) &&
          !(
            $scope.rfiData.population.type == "A" &&
...
>>>>>>> 40e4e4f4695f3564a9198dbecdaa614b1bde162e
    ...
    $scope.duplicateAction = function () {
      if ($scope.rfiData.duplicate_rfi.rfi_same == "1") {
        ...
        if (
          confirm("Are sure? This will clear the RFI you have just entered.")
        ) {
...
>>>>>>> 40e4e4f4695f3564a9198dbecdaa614b1bde162e
    ...
    $scope.savePurpose = function (direction) {
      ...
      if (direction === "back") {
        ...
        var valid_other_purpose =
          !$scope.rfiData.purpose.other_category ||
          $scope.rfiData.purpose.other;
