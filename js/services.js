angular.module('EpicoreApp.services', [])
   .run(['$rootScope', '$location', 'authService', function ($rootScope, $location, authService) {
        $rootScope.$on("$routeChangeStart", function (event, next, current) {
            ...
            var nonauthpages = new Array('fetp', 'about', 'terms', 'mod', 'application', 'application_confirm', 'approval', 'login', 'setpassword', 'resetpassword','who','how','educator','provider','professional','researcher');
